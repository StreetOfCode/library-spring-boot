...
import sk.streetofcode.library.db.mapper.CategoryRowMapper
import sk.streetofcode.library.domain.Category
import java.sql.Connection
import java.sql.PreparedStatement

@Repository
class CategoryRepository(private val categoryRowMapper: CategoryRowMapper, private val jdbcTemplate: JdbcTemplate) {
    companion object {
