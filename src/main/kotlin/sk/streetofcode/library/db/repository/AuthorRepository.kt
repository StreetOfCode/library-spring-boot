...
import sk.streetofcode.library.db.mapper.AuthorRowMapper
import sk.streetofcode.library.domain.Author
import java.sql.Connection
import java.sql.PreparedStatement

@Repository
class AuthorRepository(private val authorRowMapper: AuthorRowMapper, private val jdbcTemplate: JdbcTemplate) {
    companion object {
